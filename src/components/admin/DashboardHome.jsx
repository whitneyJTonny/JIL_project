...
const DashboardHome = () => {
  return (
    <div className="dashboard-parent">
      <Sidebar />
      <div className="dashboard-content" style={{ padding: '2rem', backgroundColor: '#f9f9f9'}}>
        <h2 style={{ color: '#1a1a1a', display: 'flex',justifyContent: 'center'  }}>Welcome to Jesus Is Lord Admin Dashboard</h2>
        <p style={{ color: '#1a1a1a', display: 'flex',justifyContent: 'center'  }}><i>Manage services, orders, and customer insights.</i></p>
        ...
        <div style={{ marginTop: '3rem' }}>
          <h3 style={{justifyContent: 'center'  }}>Service Demand Breakdown</h3>
          <div style={{ width: '100%', height: 300, justifyContent: 'center'  }}>
            <ResponsiveContainer>
              <PieChart>
                <Pie
        ...
        {/* Footer */}
        <footer style={{ textAlign: 'center', padding: '1rem 0', marginTop: '3rem', fontSize: '0.9rem', color: '#666' }}>
